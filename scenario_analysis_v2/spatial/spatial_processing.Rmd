...
# This results in 4655 polygons combining the two
...
```{r}
nlcd_county_tnc <- read_csv('data/raw_data/landuse/output_csvs/NLCD_2016_countyTNC.csv', col_types = "ncccccccnncccccccccccccccccnnnnnnnnnnnnnnnnn")
nlcd_county_tnc_hi <- read_csv('data/raw_data/landuse/output_csvs/HI_NLCD_2001_countyTNC.csv', col_types = "ncccccccnncccccccccccccccccnnnnnnnnnnnnnn")
nlcd_county_tnc_ak <- read_csv('data/raw_data/landuse/output_csvs/AK_NLCD_2016_countyTNC.csv', col_types = "ncccccccnncccccccccccccccccnnnnnnnnnnnnnnnnnnnn")
