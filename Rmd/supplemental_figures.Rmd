...
## Figures S13-S24. Maps showing domestic goods production across scenarios
...
Figure S24 shows the total across the ten groups of goods divided by the baseline value, resulting in a difference for each scenario relative to the baseline.
...
\caption*{Figure S24: Change in production relative to baseline of all agricultural goods in each county by diet and waste scenario}
\end{figure}

\newpage

## Figure S25. Maps showing domestic goods production, baseline scenario only

Figure S25 shows the baseline scenario only for domestic production of each of the primary agricultural goods, spatially disaggregated by USA county. It shows the domestic production, by value in million USD, of the ten primary agricultural goods listed above in this document, as well the total. Each panel shows production for a different good. Note that these correspond to the upper left panels of Figures S13-S23.

\begin{figure}[H]
\centerline{\includegraphics[width=0.8\textwidth]{\fpfig/paneled_baseline_maps/county_goods_flow_outbound.png}}
\caption*{Figure S25: Total production value of agricultural goods in each county in the baseline scenario}
\end{figure}

\newpage

## Figures S26-S27. Maps showing virtual land exports across scenarios

The following set of figures shows the total virtual land exports (production) of each county in the United States under all combinations of diet and waste scenario, summed across all land use types (annual cropland, permanent cropland, and pastureland). Virtual land exports are shown in hectares (ha). Layout of panels and other details are the same as in the goods export figures above. Figure S26 shows the absolute values for each scenario, and Figure S27 the percent change relative to the baseline value. Maps disaggregated by land use type can be generated using the [Shiny app](https://qdread.shinyapps.io/biodiversity-farm2fork/).

\begin{figure}[H]
\centerline{\includegraphics[width=0.8\textwidth]{\fpfig/paneled_maps/10scenarios_county_totalland_outbound.png}}
\caption*{Figure S26: Virtual land export summed across land use types from each county by diet and waste scenario}
\end{figure}

\begin{figure}[H]
\centerline{\includegraphics[width=0.8\textwidth]{\fpfig/paneled_maps/10scenarios_county_totalland_outbound_vs_baseline.png}}
\caption*{Figure S27: Change relative to baseline in virtual land export summed across land use types from each county by diet and waste scenario}
\end{figure}

\newpage

## Figure S28. Maps showing virtual land exports, baseline scenario only

Figure S28 shows the baseline scenario only for virtual exports of each of the land use types, spatially disaggregated by USA county. Values are in units of hectares. The figure has a separate panel for annual cropland, permanent cropland, pastureland, and the total across all four land use types.

\begin{figure}[H]
\centerline{\includegraphics[width=0.8\textwidth]{\fpfig/paneled_baseline_maps/county_land_flow_outbound.png}}
\caption*{Figure S28: Virtual land exports from each county in the baseline scenario}
\end{figure}

\newpage

## Figures S29-S30. Maps showing foreign virtual land imports to the United States across scenarios

The following set of figures shows the virtual land imports to the United States from all foreign trading partners across all combinations of diet and waste scenarios, both as absolute values in hectares (Figure S29) and percentage change relative to baseline (Figure S30). These world maps use the Robinson equal-area projection. Color scales and layout of panels are as described above. Maps disaggregated by land use type can be generated using the [Shiny app](https://qdread.shinyapps.io/biodiversity-farm2fork/).

\begin{figure}[H]
\centerline{\includegraphics[width=0.8\textwidth]{\fpfig/paneled_foreign_maps/10scenarios_country_total_outbound.png}}
\caption*{Figure S29: Virtual imports totaled across all land use types from all countries to the United States by diet and waste scenario}
\end{figure}
...
\caption*{Figure S30: Change relative to baseline in virtual imports totaled across all land use types from all countries to the United States by diet and waste scenario}
\end{figure}

\newpage

## Figures S31-S36. Maps showing virtual biodiversity threat exports across scenarios

The following set of figures shows the total virtual biodiversity threat exports (production) of each county in the United States under all combinations of diet and waste scenario, with separate figures for plants, the sum of all animal taxa (amphibians, birds, mammals, and reptiles), and the total of plants and animals. Virtual biodiversity threat exports are shown in units of number of species threatened by eventual extinction. Layout of panels and other details are the same as in the goods export figures above. Figures S31-33 show the absolute values for each scenario for each of the taxonomic groups, and Figures S34-36 the percent change relative to the baseline value. Maps disaggregated by taxonomic group can be generated using the [Shiny app](https://qdread.shinyapps.io/biodiversity-farm2fork/).
...
\caption*{Figure S31: Virtual export of threats to plant biodiversity from each county by diet and waste scenario}
\end{figure}
...
\caption*{Figure S32: Virtual export of threats to animal biodiversity from each county by diet and waste scenario (totaled across the four animal taxonomic groups)}
\end{figure}
...
\caption*{Figure S33: Virtual export of threats to all biodiversity from each county by diet and waste scenario (totaled across all plant and animal taxa)}
\end{figure}
...
\caption*{Figure S34: Change relative to baseline in virtual export of threats to plant biodiversity from each county by diet and waste scenario}
\end{figure}
...
\caption*{Figure S35: Change relative to baseline in virtual export of threats to animal biodiversity from each county by diet and waste scenario (totaled across the four animal taxonomic groups)}
\end{figure}
...
\caption*{Figure S38: Virtual imports of threats to plant biodiversity from all countries to the United States by diet and waste scenario}
\end{figure}
...
\caption*{Figure S39: Virtual imports of threats to animal biodiversity from all countries to the United States by diet and waste scenario}
\end{figure}
...
\caption*{Figure S40: Virtual imports of total threats to plant and animal biodiversity from all countries to the United States by diet and waste scenario}
\end{figure}
...
\caption*{Figure S41: Change relative to baseline in virtual imports of threats to plant biodiversity from all countries to the United States by diet and waste scenario}
\end{figure}
...
\caption*{Figure S42: Change relative to baseline in virtual imports of threats to animal biodiversity from all countries to the United States by diet and waste scenario}
\end{figure}
...
\caption*{Figure S43: Change relative to baseline in virtual imports of total threats to plant and animal biodiversity from all countries to the United States by diet and waste scenario}
\end{figure}
