...
Please note that not all possible visualizations of data and model results are presented in this document. To interactively view results and generate tables, plots, and maps, please visit <https://qdread.shinyapps.io/biodiversity-farm2fork>.
...
## Figure S35. Maps showing domestic goods production, baseline scenario only

Figure S35 shows the baseline scenario only for domestic production of each of the primary agricultural goods, spatially disaggregated by USA county. It shows the domestic production, by value in million USD, of the ten primary agricultural goods listed above in this document, as well the total. Each panel shows production for a different good. Note that these correspond to the upper left panels of Figures S13-S23.
...
## Figure S44. Maps showing virtual land exports, baseline scenario only

Figure S44 shows the baseline scenario only for virtual exports of each of the land use types, spatially disaggregated by USA county (note this corresponds to upper left panels of Figures S36-S39). Values are in units of hectares. The figure has a separate panel for annual cropland, permanent cropland, pastureland, and the total across all four land use types.
...
\caption*{Figure S50: Change relative to baseline in virtual imports of annual cropland from all countries to the United States by diet and waste scenario}
\end{figure}
...
\caption*{Figure S51: Change relative to baseline in virtual imports of permanent cropland from all countries to the United States by diet and waste scenario}
\end{figure}
...
\caption*{Figure S52: Change relative to baseline in virtual imports of mixed or unspecified cropland from all countries to the United States by diet and waste scenario}
\end{figure}
...
\caption*{Figure S53: Change relative to baseline in virtual imports of pastureland from all countries to the United States by diet and waste scenario}
\end{figure}
...
\caption*{Figure S55: Virtual export of threats to plant biodiversity from each county by diet and waste scenario}
\end{figure}
...
\caption*{Figure S56: Virtual export of threats to amphibian biodiversity from each county by diet and waste scenario}
\end{figure}
...
\caption*{Figure S57: Virtual export of threats to bird biodiversity from each county by diet and waste scenario}
\end{figure}
...
\caption*{Figure S58: Virtual export of threats to mammal biodiversity from each county by diet and waste scenario}
\end{figure}
...
\caption*{Figure S59: Virtual export of threats to reptile biodiversity from each county by diet and waste scenario}
\end{figure}
...
\caption*{Figure S60: Virtual export of threats to animal biodiversity from each county by diet and waste scenario (totaled across the four animal taxonomic groups)}
\end{figure}
...
\caption*{Figure S61: Virtual export of threats to all biodiversity from each county by diet and waste scenario (totaled across all plant and animal taxa)}
\end{figure}
...
\caption*{Figure S62: Change relative to baseline in virtual export of threats to plant biodiversity from each county by diet and waste scenario}
\end{figure}
...
\caption*{Figure S63: Change relative to baseline in virtual export of threats to amphibian biodiversity from each county by diet and waste scenario}
\end{figure}
...
\caption*{Figure S64: Change relative to baseline in virtual export of threats to bird biodiversity from each county by diet and waste scenario}
\end{figure}
...
\caption*{Figure S65: Change relative to baseline in virtual export of threats to mammal biodiversity from each county by diet and waste scenario}
\end{figure}
...
\caption*{Figure S66: Change relative to baseline in virtual export of threats to reptile biodiversity from each county by diet and waste scenario}
\end{figure}
...
\caption*{Figure S67: Change relative to baseline in virtual export of threats to animal biodiversity from each county by diet and waste scenario (totaled across the four animal taxonomic groups)}
\end{figure}
...
\caption*{Figure S68: Change relative to baseline in virtual export of threats to all biodiversity from each county by diet and waste scenario (totaled across all plant and animal taxa)}
\end{figure}

\newpage

## Figure S69. Maps showing virtual biodiversity threat exports, baseline scenario only

Figure S69 shows the baseline scenario only for virtual exports of threats to biodiversity for each of the taxonomic groups, spatially disaggregated by USA county (note this corresponds to upper left panels of Figures S55-S61). Values are in units of potential species extinctions. The figure has a separate panel for plants, amphibians, birds, mammals, reptiles, total across the four animal taxa, and total across both animals and plants.

\begin{figure}[H]
\centerline{\includegraphics[width=0.8\textwidth]{\fpfig/paneled_baseline_maps/county_totalland_extinction_outbound.png}}
\caption*{Figure S69: Virtual biodiversity threat exports from each county in the baseline scenario}
\end{figure}

\newpage

## Figures S70-S75. Maps showing foreign virtual biodiversity threat imports to the United States across scenarios

The following set of figures shows the virtual biodiversity threat imports to the United States from all foreign trading partners across all combinations of diet and waste scenarios, both as absolute values in potential species extinctions (Figures S70-S72) and percentage change relative to baseline (Figures S83-S75). A separate figure is shown for imported threats to plants, animals (total across taxa), and total of plant and animal threats. These world maps use the Robinson equal-area projection. Color scales and layout of panels are as described above.
...
\caption*{Figure S70: Virtual imports of threats to plant biodiversity from all countries to the United States by diet and waste scenario}
\end{figure}
...
\caption*{Figure S71: Virtual imports of threats to animal biodiversity from all countries to the United States by diet and waste scenario}
\end{figure}
...
\caption*{Figure S72: Virtual imports of total threats to plant and animal biodiversity from all countries to the United States by diet and waste scenario}
\end{figure}
...
\caption*{Figure S73: Change relative to baseline in virtual imports of threats to plant biodiversity from all countries to the United States by diet and waste scenario}
\end{figure}
...
\caption*{Figure S74: Change relative to baseline in virtual imports of threats to animal biodiversity from all countries to the United States by diet and waste scenario}
\end{figure}
...
\caption*{Figure S75: Change relative to baseline in virtual imports of total threats to plant and animal biodiversity from all countries to the United States by diet and waste scenario}
\end{figure}
