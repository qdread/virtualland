...
sheet_data <- xlsx_cells(file.path(fp, 'biodiversity/chaudhary2015SI/chaudhary_brooks_2018_si.xlsx'))
...
write_csv(ecoregion_data_final, file.path(fp, 'biodiversity/chaudhary2015SI/chaud2018si_ecoregions.csv'))
write_csv(cf_data_final, file.path(fp, 'biodiversity/chaudhary2015SI/chaud2018si_CFs.csv'))
